...
const CardioResultScreen = ({ navigation }) => {
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.questionText}>
            1. What is your preferred cardio activity?
          </Text>
        </View>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.questionText}>
            2. How long can you sustain your chosen cardio activity without
            taking a break?
          </Text>
        </View>
        <View style={styles.optionsContainer}>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.questionText}>
            3. How would you describe the intensity of your cardio workouts?
          </Text>
        </View>
        <View style={styles.optionOneRowContainer}>
          {renderOption(
            2,
            "Low intensity, mostly leisurely pace",
            "Moderate intensity, breaking a sweat but not too challenging",
            styles.optionOneRow
          )}
          {renderOption(
            2,
            "High intensity, pushing my limits and feeling breathless",
            "I do not engage in cardio workouts",
            styles.optionOneRow
          )}
        </View>
        <View style={styles.questionContainer}>
          <Text style={styles.questionText}>
            4. How often do you engage in cardio exercises per week?
          </Text>
        </View>
        <View style={styles.optionOneRowContainer}>
          {renderOption(
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.questionText}>
            5. Have you noticed improvements in your cardiovascular fitness over
            the past few months?
          </Text>
        </View>
        <View style={styles.optionOneRowContainer}>
