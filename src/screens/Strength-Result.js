        ...
        <View style={styles.container}>
            ...
            <ScrollView 
                ...
                <View style={styles.questionContainer}>
                    <Text style={styles.questionText}>1. How many push-ups can you do in one set?</Text>
                </View>
                ...
                <View style={styles.questionContainer}>
                    <Text style={styles.questionText}>2. How long can you hold a plank position without dropping?</Text>
                </View>
                <View style={styles.optionsContainer}>
                ...
                <View style={styles.questionContainer}>
                    <Text style={styles.questionText}>3. How do you feel after doing a set of lunges?</Text>
                </View>
                <View style={styles.optionOneRowContainer}>
                    {renderOption(2, 'Exhausted and unable to continue', 'A bit fatigued but can do more', styles.optionOneRow)}
                    {renderOption(2, 'Energized and ready for more exercise', 'I have not tried lunges before', styles.optionOneRow)}
                </View>
                <View style={styles.questionContainer}>
                    <Text style={styles.questionText}>4. Have you tried plank jacks before?</Text>
                </View>
                <View style={styles.optionOneRowContainer}>
                    {renderOption(3, 'Yes, and I can do them with ease', 'Yes, but they are challenging for me', styles.optionOneRow)}
                    {renderOption(3, 'No, but I am willing to try', 'No, and I am not interested in trying', styles.optionOneRow)}
                </View>
                <View style={styles.questionContainer}>
                    <Text style={styles.questionText}>5.  How frequently do you engage in strength training exercises like push-ups, planks, lunges, or plank jacks?</Text>
                </View>
                <View style={styles.optionOneRowContainer}>
                    {renderOption(4, 'Rarely or never', 'Occasionally, maybe once a week', styles.optionOneRow)}
                    {renderOption(4, 'Regularly, 2-3 times a week', 'Very frequently, almost every day', styles.optionOneRow)}
                </View>
