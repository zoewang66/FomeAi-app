        ...
        <KeyboardAvoidingView 
            ...
            <SafeAreaView>
                <ScrollView 
                    ...
                    <Text style={styles.info}>Please help us to know more about you!</Text>
            
                    <View style={styles.form}>
                        <Text style={styles.label}>Username</Text>
                        <TextInput style={styles.input} placeholder="Enter your username" onFocus={scrollToPasswordInput} />
                        <Text style={styles.label}>Email</Text>
                        <TextInput style={styles.input} placeholder="email@example.com" onFocus={scrollToPasswordInput} keyboardType="email-address"/>
                        ...
                        <View style={styles.inputGroup}>
                            <View style={styles.inputContainer}>
                                ...
                                <TouchableOpacity onPress={togglePicker} style={styles.pickerHeader}>
                                    <Text style={styles.pickerHeaderText}>{selectedGender ? selectedGender : "Select Gender"}</Text>
                                </TouchableOpacity>
                            ...
                            <View style={styles.inputContainer}>
                                ...
                                <TextInput style={[styles.input, styles.largeInput]} placeholder="Age" onFocus={scrollToPasswordInput} keyboardType="numeric"/>
                            </View>
                        </View>
                        <Text style={styles.label}>Gym Affiliation</Text>
                        <TextInput style={styles.input} placeholder="Enter your gym affiliation" onFocus={scrollToPasswordInput}/>
                    </View>
